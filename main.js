...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onSubmitDrink = function () {
        var _this = this;
        this.listDrinks.filter(function (drink) {
            if (drink.drinkNumber === _this.newDrink) {
                drink.exist = true;
            }
        });
    };
